            ...
            <div class="app-layout animate-mount">
                <aside class="sidebar${sidebarCollapsed ? ' collapsed' : ''}">
                    ...
                    <nav class="sidebar-nav">
                        ...
                        ` : ''}
                        <div id="logoutBtn" class="nav-item" style="margin-top:auto; border-top:1px solid var(--border-light); padding-top:1rem; opacity:0.7; cursor:pointer;">
                        ...
                        <div id="themeToggle" class="nav-item" style="border-top:1px solid var(--border-light); padding-top:1rem; opacity:0.7;">
